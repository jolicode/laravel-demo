<x-admin-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg my-12">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tr>
                <th scope="col" class="px-6 py-3">{{ __('label.title') }}</th>
                <th scope="col" class="px-6 py-3"><i class="fa fa-calendar" aria-hidden="true"></i> {{ __('label.published_at') }}</th>
                <th scope="col" class="px-6 py-3 text-right" class="text-center"><i class="fa fa-cogs" aria-hidden="true"></i> {{ __('label.actions') }}</th>
            </tr>
            </thead>
            <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" align="center">{{ __('post.no_posts_found') }}</td>
                </tr>
            @endforelse
            </tbody>
        </table>
